...
function pb_post_list($pluginName, $hookData, $connect) {
...
function pb_post_save($pluginName, $hookData, $connect) {
...
function pb_post_edit_get($pluginName, $hookData, $connect) {
...
function pb_post_edit_save($pluginName, $hookData, $connect) {
	$hookDataArr = new ArrayObject($hookData);
	$hookData = $hookDataArr->getArrayCopy();
